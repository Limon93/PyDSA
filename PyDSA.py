...
#corretto posizionamento onda - cerca  lunga fila di asterischi 
...
def MakeTrace():        # Update the grid and trace
    ...
    Fsample = float(SAMPLErate) / (TRACEsize - 1)       # Frequency step per sample  CAMBIAMENTO EFFETTUATO QUA, tolto fratto due a SAMPLErate/2 ######################################################################################################################################################################################################################################################################################################################################################
